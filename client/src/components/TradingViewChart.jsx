  ...
  useEffect(() => {
    ...
    try {
      ...
      const generateBitcoinData = () => {
        ...
        // (no-op) final price will be updated by live updates
      ...
      // Simulate live price updates using functional state update to avoid stale closures
      const interval = setInterval(() => {
        const randomChange = (Math.random() - 0.5) * 1000;
        setCurrentPrice((prevPrice) => {
          const newPrice = Math.max(prevPrice + randomChange, 20000);
          const newData = {
