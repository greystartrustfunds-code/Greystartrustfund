...
const Transactions = ({ setCurrentPage, setIsAuthenticated }) => {
  ...
  const handleGoFilter = () => {
    const filters = {
      type: transactionType === "All transactions" ? undefined : transactionType.toLowerCase(),
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-sm font-medium text-gray-700 text-right">Date</div>
            </div>
          </div>
            ...
            {!loading && !error && transactions.length > 0 && (
              <div>
                {transactions.map((transaction, index) => (
                  <div key={transaction.id || index} className="px-6 py-4 border-b border-gray-100 hover:bg-gray-50">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">Copyright © exon-energy.com 2024. All Rights Reserved.</p>
        </div>
